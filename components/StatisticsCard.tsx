...
const StatisticsCard = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 review-widget-slide-in">
      {isLoading ? (
        <div className="animate-pulse">
          ...
          <div className="w-16 h-8 bg-gray-200 dark:bg-gray-700 rounded mt-1"></div>
          <div className="w-24 h-4 bg-gray-200 dark:bg-gray-700 rounded mt-3"></div>
        </div>
      ) : (
        <>
          <div className="flex items-center justify-between">
